...
public class Calculadora extends JFrame 
{
   ...
   private final JButton goJButton = new JButton( "Operar" );
   ...
   public Calculadora()
   {
      ...
      workerJPanel.add( new JLabel( "Evalua expresión como 2+1-1*100" ) );
      ...
      goJButton.addActionListener( 
         new ActionListener()
         {
            ...
            {
               String str="";
		str = numberJTextField.getText();
               fibonacciJLabel.setText( "Calculando..." );
               BackgroundCalculadora task = 
               new BackgroundCalculadora( str, fibonacciJLabel );         
               task.execute(); 
            } // end method 
